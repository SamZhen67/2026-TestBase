...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.1).withKI(0).withKD(0).withKS(0.1325).withKV(0.6785);
  ...
  public static final CANBus kCANBus = new CANBus("1468_CANivore", "./logs/example.hoot");
  ...
  private static final Distance kWheelRadius = Inches.of(1.945);
